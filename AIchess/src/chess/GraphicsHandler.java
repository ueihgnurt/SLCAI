...
public class GraphicsHandler extends JPanel
{
	...
	public void setAI(AI2 ai2) throws Exception
	{
		
		if(ai2 == null)
			throw new Exception("null AI object in setAI()");
		this.ai2 = ai2;
		if( ai2.getColour().equals( board.getCurrentTurn() ) && 
			!board.isCheckMate(ai2.getColour()) &&
			!board.isCheckMate(Board.opposite(ai2.getColour())))
			ai2.playNextMove();
	}
	/**
	...
	private void clicked(int x, int y)
	{
		...
		moveHappened = board.clicked(Board.rowMax-row , 
											 col+Board.colMin);
	}
