...
{	
	...
	private int valueOf(Piece piece)
	{
		...
		{
			if(piece.getColour() == "Black") return 2900;
			return 900;
		}
		else if(piece instanceof Queen)
		{
			if(piece.getColour() == "Black") return 2090;
			return 90;
		}
		else if(piece instanceof Rook)
		{
			if(piece.getColour() == "Black") return 2050;
			return 50;
		}
		else if(piece instanceof Bishop)
		{
			if(piece.getColour() == "Black") return 2030;
			return 30;
		}
		...
		{
			if(piece.getColour() == "Black") return 2010;
			return 10;
		}
		else
			return 2000;
	...
	public double[] getTest()
	{
		...
		for(int i=0;i<8;i++)
			...
			{
				Piece onThis = movement.getPieceOn(cells[i][j]);
				k[i*8+j] = (valueOf(onThis)-2000.0)/2000.0;
			}
		return k;
	}
	/**
